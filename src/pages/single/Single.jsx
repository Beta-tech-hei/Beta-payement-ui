  ...
  return (
    <div className="single">
      ...
      <div className="singleContainer">
          ...
          <div className="left">
            ...
            <div className="item">
              ...
              <div className="details">
                <h1 className="itemTitle">Rakoto Fenohasina</h1>
                <div className="detailItem">
                  <span className="itemKey">REFERENCES :</span>
                  <span className="itemKey">STD23025</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">GROUP :</span>
                  <span className="itemKey">I5</span>
                </div>
                <div className="detailItem">
                  <span className="itemKey">MAIL :</span>
                  <span className="itemKey">hei.fenohasina</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <h1 className="title">Last Payement</h1>
          <List/>
        </div>
      </div>
    </div>
